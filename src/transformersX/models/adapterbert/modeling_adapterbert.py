...
ADAPTERBERT_INPUTS_DOCSTRING = r"""
    Args:
...
@add_start_docstrings(
    "The bare AdapterBert Model transformer outputting raw hidden-states without any specific head on top.",
    ADAPTERBERT_START_DOCSTRING,
)
class AdapterBertModel(AdapterBertPreTrainedModel):
    """
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.embeddings = AdapterBertEmbeddings(config)
...
@add_start_docstrings(
    """
    AdapterBert Model transformer with a sequence classification head on top (a linear layer on top of the pooled output).
    """,
    ADAPTERBERT_START_DOCSTRING,
)
class AdapterBertForSequenceClassification(AdapterBertPreTrainedModel):
